...
![Spiral](02_battle_dimensions/spiral.png)

В ходе разработки игры встал вопрос, а каков баланса игры. По хорошему нужно было создать пробные наборы игры(сверстать, распечатать), собрать фокус группу (любителей настолок, человек 5-10), дать им поиграть 10+ партий в своих компаниях, собрать от них статистику, обработать результаты по всем партий, внести правки в механику игры чтобы выровнять баланс, повторить все действия.

Однако это все очень затратно и долго. Я как программист, решил посчитать баланс с помощью Python. Скрипты с кодом доступны в папке. Расчеты ниже.
